        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="px-6 text-center">Prospects</TableHead>
              <TableHead className="px-6 text-center">Outreach</TableHead>
              <TableHead className="px-6 text-center">Meetings</TableHead>
              <TableHead className="pl-10">Reps</TableHead>
              <TableHead className="pr-2">
                <div className="ml-auto w-[8.5rem] text-center">Control</div>
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            ...
            {rows.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="px-6 text-center tabular-nums">{c.meetings}</TableCell>
                  ...
                  <TableCell className="pr-2">
                    <div className="ml-auto flex w-[8.5rem] items-center justify-center gap-2">
                      {c.status === "live" && (
                        <Button
                          size="sm"
                          variant="outline"
                      ...
                      {c.status === "completed" && <div className="w-24" />}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                          {c.status !== "archived" && (
                            <DropdownMenuItem onSelect={() => navigate(`/campaigns/${c.id}/edit`)}>
